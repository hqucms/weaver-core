...
class ParticleEdgeNeXt(nn.Module):
    ...
    def forward(self, points, features, lorentz_vectors, mask=None, edge_features_tensor=None):
        # print('points:\n', points)
        # print('features:\n', features)
...
class ParticleEdgeNeXtTagger(nn.Module):
    ...
    def forward(self, pf_points, pf_features, pf_vectors, pf_mask, sv_points, sv_features, sv_vectors, sv_mask,  edge_list, edge_features, edge_features_mask):
        ...
        edge_features_tensor=build_sparse_tensor(edge_list, edge_features, pf_features.size(2))
        return self.pn(points, features, lorentz_vectors, mask, edge_features_tensor)
